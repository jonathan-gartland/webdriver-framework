...
class BrowserstackService {
  ...
  _update(sessionId, requestBody) {
    return new Promise((resolve, reject) => {
      _request.default.put(`https://www.browserstack.com/automate/sessions/${sessionId}.json`, {
        json: true,
        auth: this.auth,
        body: requestBody
      }, (error, response, body) => {
  ...
  _printSessionURL() {
    ...
    return new Promise((resolve, reject) => _request.default.get(`https://www.browserstack.com/automate/sessions/${this.sessionId}.json`, {
      json: true,
      auth: this.auth
    }, (error, response, body) => {
      if (error) {
